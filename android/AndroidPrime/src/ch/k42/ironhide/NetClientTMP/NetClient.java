...
public class NetClient {
    ...
    private static final List<Class> quorgs = new ArrayList();
    static {
        quorgs.add(Matrix.class);
        quorgs.add(MailQuorg.class);
        quorgs.add(ColorQuorg.class);
        quorgs.add(BinaryClock.class);
        quorgs.add(Nexus.class);
        quorgs.add(RainbowEffect.class);
        quorgs.add(RandomQuorg.class);
        quorgs.add(TextEffect.class);
        quorgs.add(Wave.class);
    }
